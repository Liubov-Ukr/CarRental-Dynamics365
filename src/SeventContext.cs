...
namespace SeventPlugins
{
	...
	/// </summary>
	public partial class SeventContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		
		/// <summary>
		/// Constructor.
		/// </summary>
		public SeventContext(Microsoft.Xrm.Sdk.IOrganizationService service) : 
				base(service)
		{
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="SeventPlugins.SEvent_Car"/> entities.
		/// </summary>
		public System.Linq.IQueryable<SeventPlugins.SEvent_Car> SEvent_CarSet
		{
			get
			{
				return this.CreateQuery<SeventPlugins.SEvent_Car>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="SeventPlugins.SEvent_CarClass"/> entities.
		/// </summary>
		public System.Linq.IQueryable<SeventPlugins.SEvent_CarClass> SEvent_CarClassSet
		{
			get
			{
				return this.CreateQuery<SeventPlugins.SEvent_CarClass>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="SeventPlugins.SEvent_CarTransferReport"/> entities.
		/// </summary>
		public System.Linq.IQueryable<SeventPlugins.SEvent_CarTransferReport> SEvent_CarTransferReportSet
		{
			get
			{
				return this.CreateQuery<SeventPlugins.SEvent_CarTransferReport>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="SeventPlugins.SEvent_Customer"/> entities.
		/// </summary>
		public System.Linq.IQueryable<SeventPlugins.SEvent_Customer> SEvent_CustomerSet
		{
			get
			{
				return this.CreateQuery<SeventPlugins.SEvent_Customer>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="SeventPlugins.SEvent_Rent"/> entities.
		/// </summary>
		public System.Linq.IQueryable<SeventPlugins.SEvent_Rent> SEvent_RentSet
		{
			get
			{
				return this.CreateQuery<SeventPlugins.SEvent_Rent>();
			}
		}
	}
